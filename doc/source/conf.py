...
# -*- coding: utf-8 -*-
#
# ken.helper-functions documentation build configuration file, created by
...
modindex_common_prefix = ["ken.helper-functions"]
...
basename = "ken.helper-functions".replace(" ", "").replace(".", "")
...
latex_documents = [
    (
        "index",
        "ken.helper-functions.tex",
        "ken.helper-functions Documentation",
        ab_authors,
        "manual",
    ),
]
